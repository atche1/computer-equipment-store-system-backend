...
Уеб базирана система за онлайн магазин за компютърна техника и услуги. 
Системата позволява управление на продукти, категории, поръчки и сервизни заявки, 
както и регистрация и автентикация на потребители чрез JWT.
